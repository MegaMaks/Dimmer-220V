...
#include <mega328p.h>
#include <delay.h>
unsigned char light1=20;
unsigned char light2=50;
...
DDRB=(0<<DDB7) | (0<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (1<<DDB0);
...
while (1)
      {
       //Place your code here
        if(rx_counter0)
                  {
                  getch=getchar(); 
                  if(getch=='1')light1 = 10;
                  if(getch=='2')light1 = 20;
                  if(getch=='3')light1 = 30;
                  if(getch=='4')light1 = 40;
                  if(getch=='5')light1 = 50;
                  if(getch=='6')light1 = 60;
                  if(getch=='7')light1 = 70;
                  if(getch=='8')light1 = 80;
                  if(getch=='9')light1 = 90;
                  if(getch=='0')light1 =100;
